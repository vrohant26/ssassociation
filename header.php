                ...
                <div class="fp-image-meta">
                    <div class="fp-socials">
                        ...
                        <div class="menu-text-mask">
                            <a target="_blank" href="https://www.instagram.com/s_sassociates17/" class="social-icon menu-reveal-item">
                    ...
                    <div class="fp-address">
                        <div class="menu-text-mask"><div class="menu-reveal-item">Chembur, Mumbai</div></div>
                    </div>
                </div>
            </div>
        </div>
