    ...
    <section class="team-section gsap-reveal-section">
        <div class="container text-center" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
            ...
            <div class="director-profile" style="width: 100%; max-width: 450px; text-align: left;">
                ...
                <div class="text-mask">
                    <h4 class="director-name" style="font-size: 1rem; color: #1f1f1f; font-weight: 700; margin: 0; display: flex; align-items: center; gap: 0.5rem; letter-spacing: 0.05em;"><span style="color: black;">Pratik Ghag</span> <span style="font-size: 0.75rem; color: #666; font-weight: 600;">/ Director</span></h4>
                </div>
            </div>
        </div>
    </section>
